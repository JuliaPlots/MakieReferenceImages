...
<span class='hljl-k'>using</span><span class='hljl-t'> </span><span class='hljl-n'>Makie</span><span class='hljl-t'>
 ...
 </span><span class='hljl-n'>axis</span><span class='hljl-p'>[</span><span class='hljl-sc'>:grid</span><span class='hljl-p'>][</span><span class='hljl-sc'>:linecolor</span><span class='hljl-p'>]</span><span class='hljl-t'> </span><span class='hljl-oB'>=</span><span class='hljl-t'> </span><span class='hljl-p'>((</span><span class='hljl-sc'>:red</span><span class='hljl-p'>,</span><span class='hljl-t'> </span><span class='hljl-nfB'>0.5</span><span class='hljl-p'>),</span><span class='hljl-t'> </span><span class='hljl-p'>(</span><span class='hljl-sc'>:blue</span><span class='hljl-p'>,</span><span class='hljl-t'> </span><span class='hljl-nfB'>0.5</span><span class='hljl-p'>))</span><span class='hljl-t'>
 ...
 </span><span class='hljl-n'>axis</span><span class='hljl-p'>[</span><span class='hljl-sc'>:names</span><span class='hljl-p'>][</span><span class='hljl-sc'>:axisnames</span><span class='hljl-p'>]</span><span class='hljl-t'> </span><span class='hljl-oB'>=</span><span class='hljl-t'> </span><span class='hljl-p'>(</span><span class='hljl-s'>&quot;x&quot;</span><span class='hljl-p'>,</span><span class='hljl-t'> </span><span class='hljl-s'>&quot;y = cos(x)&quot;</span><span class='hljl-p'>)</span><span class='hljl-t'>
