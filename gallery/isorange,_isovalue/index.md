...
</span><span class='hljl-nf'>volume</span><span class='hljl-p'>(</span><span class='hljl-n'>matr</span><span class='hljl-t'> </span><span class='hljl-oB'>.*</span><span class='hljl-t'> </span><span class='hljl-p'>(</span><span class='hljl-n'>matr</span><span class='hljl-t'> </span><span class='hljl-oB'>.&gt;</span><span class='hljl-t'> </span><span class='hljl-nfB'>1.4</span><span class='hljl-p'>),</span><span class='hljl-t'> </span><span class='hljl-n'>algorithm</span><span class='hljl-t'> </span><span class='hljl-oB'>=</span><span class='hljl-t'> </span><span class='hljl-sc'>:iso</span><span class='hljl-p'>,</span><span class='hljl-t'> </span><span class='hljl-n'>isorange</span><span class='hljl-t'> </span><span class='hljl-oB'>=</span><span class='hljl-t'> </span><span class='hljl-nfB'>0.05</span><span class='hljl-p'>,</span><span class='hljl-t'> </span><span class='hljl-n'>isovalue</span><span class='hljl-t'> </span><span class='hljl-oB'>=</span><span class='hljl-t'> </span><span class='hljl-nfB'>1.7</span><span class='hljl-p'>)</span><span class='hljl-t'>
...
<div style="display:inline-block">
    <p style="display:inline-block; text-align: center">
        <img src="http://juliaplots.org/MakieReferenceImages/gallery//isorange,_isovalue/media/image.png" alt="">
