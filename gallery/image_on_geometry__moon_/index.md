...
<span class='hljl-k'>using</span><span class='hljl-t'> </span><span class='hljl-n'>Makie</span><span class='hljl-t'>
     ...
     </span><span class='hljl-nd'>@warn</span><span class='hljl-p'>(</span><span class='hljl-s'>&quot;Download the moon failed. Using random image, so this test will fail! (error: </span><span class='hljl-si'>$e</span><span class='hljl-s'>)&quot;</span><span class='hljl-p'>)</span><span class='hljl-t'>
