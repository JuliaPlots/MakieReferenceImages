...
</span><span class='hljl-k'>function</span><span class='hljl-t'> </span><span class='hljl-nf'>colormesh</span><span class='hljl-p'>((</span><span class='hljl-n'>geometry</span><span class='hljl-p'>,</span><span class='hljl-t'> </span><span class='hljl-n'>color</span><span class='hljl-p'>))</span><span class='hljl-t'>
    </span><span class='hljl-n'>mesh1</span><span class='hljl-t'> </span><span class='hljl-oB'>=</span><span class='hljl-t'> </span><span class='hljl-nf'>normal_mesh</span><span class='hljl-p'>(</span><span class='hljl-n'>geometry</span><span class='hljl-p'>)</span><span class='hljl-t'>
    </span><span class='hljl-n'>npoints</span><span class='hljl-t'> </span><span class='hljl-oB'>=</span><span class='hljl-t'> </span><span class='hljl-nf'>length</span><span class='hljl-p'>(</span><span class='hljl-n'>GeometryBasics</span><span class='hljl-oB'>.</span><span class='hljl-nf'>coordinates</span><span class='hljl-p'>(</span><span class='hljl-n'>mesh1</span><span class='hljl-p'>))</span><span class='hljl-t'>
    </span><span class='hljl-k'>return</span><span class='hljl-t'> </span><span class='hljl-n'>GeometryBasics</span><span class='hljl-oB'>.</span><span class='hljl-nf'>pointmeta</span><span class='hljl-p'>(</span><span class='hljl-n'>mesh1</span><span class='hljl-p'>;</span><span class='hljl-t'> </span><span class='hljl-n'>color</span><span class='hljl-oB'>=</span><span class='hljl-nf'>fill</span><span class='hljl-p'>(</span><span class='hljl-n'>color</span><span class='hljl-p'>,</span><span class='hljl-t'> </span><span class='hljl-n'>npoints</span><span class='hljl-p'>))</span><span class='hljl-t'>
...
</span><span class='hljl-n'>meshes</span><span class='hljl-t'> </span><span class='hljl-oB'>=</span><span class='hljl-t'> </span><span class='hljl-nf'>map</span><span class='hljl-p'>(</span><span class='hljl-n'>colormesh</span><span class='hljl-p'>,</span><span class='hljl-t'> </span><span class='hljl-n'>rectangles</span><span class='hljl-p'>)</span><span class='hljl-t'>
...
<div style="display:inline-block">
    <p style="display:inline-block; text-align: center">
        <img src="http://juliaplots.org/MakieReferenceImages/gallery//merged_color_mesh/media/image.png" alt="">
